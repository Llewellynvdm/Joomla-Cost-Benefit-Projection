...
// Some Global Values
jform_swircAVgee_required = false;
jform_swircAVOxG_required = false;
jform_swircAVFEf_required = false;
jform_swircAVRgx_required = false;
jform_swircAVTMU_required = false;
jform_swircAVqMN_required = false;
jform_swircAVGYz_required = false;
...
// the swircAV function
function swircAV(department_swircAV)
{
	// set the function logic
	if (department_swircAV == 2)
	{
		jQuery('#jform_causesrisks').closest('.control-group').show();
		if (jform_swircAVgee_required)
		{
	...
	else
	{
		...
		if (!jform_swircAVgee_required)
		{
			...
			jform_swircAVgee_required = true;
		}
		...
		if (!jform_swircAVOxG_required)
		{
			...
			jform_swircAVOxG_required = true;
		}
		...
		if (!jform_swircAVFEf_required)
		{
			...
			jform_swircAVFEf_required = true;
		}
		...
		if (!jform_swircAVRgx_required)
		{
			...
			jform_swircAVRgx_required = true;
		}
		...
		if (!jform_swircAVTMU_required)
		{
			...
			jform_swircAVTMU_required = true;
		}
		...
		if (!jform_swircAVqMN_required)
		{
			...
			jform_swircAVqMN_required = true;
		}
		...
		if (!jform_swircAVGYz_required)
		{
			...
			jform_swircAVGYz_required = true;
		}
	}
}

// the KbJXrPw function
function KbJXrPw(department_KbJXrPw)
{
	// set the function logic
	if (department_KbJXrPw == 1)
	{
