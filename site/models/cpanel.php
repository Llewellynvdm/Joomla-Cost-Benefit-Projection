...
class CostbenefitprojectionModelCpanel extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// [1791] Get from #__costbenefitprojection_country as b
		$query->select($db->quoteName(
		...
		// [1791] Get from #__costbenefitprojection_service_provider as c
		$query->select($db->quoteName(
		...
		// [1791] Get from #__costbenefitprojection_currency as g
		$query->select($db->quoteName(
	...
	*/
	public function getIdCompanyScaling_factorBdef_D($id)
	{
		...
		// [2714] Get from #__costbenefitprojection_scaling_factor as d
		$query->select($db->quoteName(
		...
		// [1791] Get from #__costbenefitprojection_causerisk as f
		$query->select($db->quoteName(
			array('f.name'),
	...
	*/
	public function getIdCompanyInterventionBdef_E($id)
	{
		...
		// [2714] Get from #__costbenefitprojection_intervention as e
		$query->select($db->quoteName(
