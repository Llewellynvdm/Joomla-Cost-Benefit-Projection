...
class CostbenefitprojectionModelCpanel extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$this->initSet		= true; 
		// [3033] Make sure all records load, since no pagination allowed.
		$this->setState('list.limit', 0);
		// [3035] Get a db connection.
		$db = JFactory::getDbo();
		...
		// [1901] Get from #__costbenefitprojection_country as b
		$query->select($db->quoteName(
		...
		// [1901] Get from #__costbenefitprojection_service_provider as c
		$query->select($db->quoteName(
		...
		// [1901] Get from #__costbenefitprojection_currency as g
		$query->select($db->quoteName(
	...
	public function getItems()
	{
		...
		// [3140] Get the advanced encription.
		$advancedkey = CostbenefitprojectionHelper::getCryptKey('advanced');
		// [3142] Get the encription object.
	...
	*/
	public function getIdCompanyScaling_factorBdef_D($id)
	{
		...
		// [2835] Get from #__costbenefitprojection_scaling_factor as d
		$query->select($db->quoteName(
		...
		// [1901] Get from #__costbenefitprojection_causerisk as f
		$query->select($db->quoteName(
			array('f.name'),
	...
	*/
	public function getIdCompanyInterventionBdef_E($id)
	{
		...
		// [2835] Get from #__costbenefitprojection_intervention as e
		$query->select($db->quoteName(
