...
class CostbenefitprojectionModelCombinedresults extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// [2152] Check if $ids is an array with values.
		$array = $ids;
