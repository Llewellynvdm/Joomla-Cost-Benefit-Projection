...
/**
 * Costbenefitprojection List Model for Combinedresults
 */
class CostbenefitprojectionModelCombinedresults extends ListModel
{
	/**
	 * Model user data.
	 *
	...
	public function getItems()
	{
		...
		{
			$app = JFactory::getApplication();
			$app->enqueueMessage(JText::_('COM_COSTBENEFITPROJECTION_NOT_AUTHORISED_TO_VIEW_COMBINEDRESULTS'), 'error');
