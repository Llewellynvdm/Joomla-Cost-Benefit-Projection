	...
	function postflight($type, $parent)
	{
		...
		if ($type == 'update')
		{
			...
			echo '<a target="_blank" href="http://www.vdm.io" title="Cost Benefit Projection">
				...
				<h3>Upgrade to Version 3.3.4 Was Successful! Let us know if anything is not working as expected.</h3>';
		}
	}
}
