...
/**
 * Costbenefitprojection Health_data Admin Model
 */
class CostbenefitprojectionModelHealth_data extends AdminModel
{
	/**
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		// Modify the form based on Edit Causerisk access controls.
		...
		// Modify the form based on Edit Maleyld access controls.
		...
		// Modify the form based on Edit Maledeath access controls.
