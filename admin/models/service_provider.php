...
/**
 * Costbenefitprojection Service_provider Admin Model
 */
class CostbenefitprojectionModelService_provider extends AdminModel
{
	/**
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		// Get the form.
		$form = $this->loadForm('com_costbenefitprojection.service_provider', 'service_provider', $options, $clear, $xpath);
	...
	protected function loadFormData() 
	{
		...
		if (empty($data))
		{
			...
			$this->preprocessData('com_costbenefitprojection.service_provider', $data);
		}
