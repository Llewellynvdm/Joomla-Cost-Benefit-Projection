...
/**
 * Costbenefitprojection Causerisk Admin Model
 */
class CostbenefitprojectionModelCauserisk extends AdminModel
{
	/**
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		// Get the form.
		$form = $this->loadForm('com_costbenefitprojection.causerisk', 'causerisk', $options, $clear, $xpath);
	...
	protected function loadFormData() 
	{
		...
		if (empty($data))
		{
			...
			$this->preprocessData('com_costbenefitprojection.causerisk', $data);
		}
