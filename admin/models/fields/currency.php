...
class JFormFieldCurrency extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($setButton === 'true')
		{
			...
			if (($buttonName == 'currency' || $buttonName == 'currencies') && $user->authorise('currency.edit', 'com_costbenefitprojection'))
			{
				// build edit button
				...
				$script[] = "
					...
					function ".$buttonName."Button(value) {
						if (value > 0) {
							...
							var url = 'index.php?option=com_costbenefitprojection&view=currencies&task=currency.edit&id='+value+'".$refJ."';
