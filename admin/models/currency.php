...
/**
 * Costbenefitprojection Currency Admin Model
 */
class CostbenefitprojectionModelCurrency extends AdminModel
{
	/**
	...
	public function getForm($data = array(), $loadData = true, $options = array('control' => 'jform'))
	{
		...
		// Get the form.
		$form = $this->loadForm('com_costbenefitprojection.currency', 'currency', $options, $clear, $xpath);
	...
	{
		return 'media/com_costbenefitprojection/js/currency.js';
	}
	...
	protected function loadFormData() 
	{
		...
		if (empty($data))
		{
			...
			$this->preprocessData('com_costbenefitprojection.currency', $data);
		}
