...
<?php if ($this->hasPackage && CostbenefitprojectionHelper::checkArray($this->headerList)) : ?>
	Joomla.continueBasicImport = function()
	{
		...
		if (error)
		{
			alert("<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_MSG_PLEASE_SELECT_ALL_COLUMNS', true); ?>");
		}
		else
		{
	...
	Joomla.continueAdvImport = function()
	{
		var form = document.getElementById('adminForm');
		var error = false;
		...
		{
			jQuery('#loading').css('display', 'block');
			form.gettype.value = 'continue-adv';
			form.submit();
		}
	};
<?php else: ?>
	Joomla.submitbutton = function()
	{
		...
		{
			alert("<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_MSG_PLEASE_SELECT_A_FILE', true); ?>");
		}
		else
		{
			jQuery('#loading').css('display', 'block');
	...
	Joomla.submitbutton3 = function()
	{
		...
		if (form.import_directory.value == ""){
			alert("<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_MSG_PLEASE_SELECT_A_DIRECTORY', true); ?>");
		}
		else
		{
			jQuery('#loading').css('display', 'block');
	...
	Joomla.submitbutton4 = function()
	{
		...
		{
			alert("<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_MSG_ENTER_A_URL', true); ?>");
		}
		else
		{
			jQuery('#loading').css('display', 'block');
...
<form enctype="multipart/form-data" action="<?php echo JRoute::_('index.php?option=com_costbenefitprojection&view=import_health_data_sets');?>" method="post" name="adminForm" id="adminForm" class="form-horizontal form-validate">
	...
	<?php if ($this->hasPackage && CostbenefitprojectionHelper::checkArray($this->headerList) && CostbenefitprojectionHelper::checkArray($this->headers)) : ?>
		...
		<fieldset class="uploadform">
			...
			<div class="control-group">
				<label class="control-label" ><h4><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_TABLE_COLUMNS'); ?></h4></label>
				<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select  name="<?php echo $name; ?>"  id="vdm_<?php echo $name; ?>" required class="required input_box" >
							...
							<option value="IGNORE"><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_IGNORE_COLUMN'); ?></option>
							<?php foreach($this->headers as $value => $option): ?>
								...
								<option value="<?php echo CostbenefitprojectionHelper::htmlEscape($value); ?>" class="required" <?php echo $selected ?>><?php echo CostbenefitprojectionHelper::htmlEscape($option); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
				</div>
			...
			<div class="form-actions">
				<input class="btn btn-primary" type="button" value="<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_CONTINUE'); ?>" onclick="Joomla.continueBasicImport()" />
			</div>
		</fieldset>
	...
	<?php else: ?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'upload', JText::_('COM_COSTBENEFITPROJECTION_IMPORT_FROM_UPLOAD', true)); ?>
			<fieldset class="uploadform">
				<legend><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_UPDATE_DATA'); ?></legend>
				<div class="control-group">
					<label for="import_package" class="control-label"><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_SELECT_FILE'); ?></label>
					<div class="controls">
						<input class="input_box" id="import_package" name="import_package" type="file" size="57" />
					</div>
				</div>
				<div class="form-actions">
					<input class="btn btn-primary" type="button" value="<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_UPLOAD_BOTTON'); ?>" onclick="Joomla.submitbutton()" />&nbsp;&nbsp;&nbsp;<small><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_FORMATS_ACCEPTED'); ?> (.csv .xls .ods)</small>
				</div>
			</fieldset>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'directory', JText::_('COM_COSTBENEFITPROJECTION_IMPORT_FROM_DIRECTORY', true)); ?>
			<fieldset class="uploadform">
				<legend><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_UPDATE_DATA'); ?></legend>
				<div class="control-group">
					<label for="import_directory" class="control-label"><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_SELECT_FILE_DIRECTORY'); ?></label>
					<div class="controls">
				...
				<div class="form-actions">
					<input type="button" class="btn btn-primary" value="<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_GET_BOTTON'); ?>" onclick="Joomla.submitbutton3()" />&nbsp;&nbsp;&nbsp;<small><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_FORMATS_ACCEPTED'); ?> (.csv .xls .ods)</small>
				</div>
				</fieldset>
		<?php echo JHtml::_('bootstrap.endTab'); ?>


		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'url', JText::_('COM_COSTBENEFITPROJECTION_IMPORT_FROM_URL', true)); ?>
			<fieldset class="uploadform">
				<legend><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_UPDATE_DATA'); ?></legend>
				<div class="control-group">
					<label for="import_url" class="control-label"><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_SELECT_FILE_URL'); ?></label>
					<div class="controls">
						<input type="text" id="import_url" name="import_url" class="span5 input_box" size="70" value="http://" />
					</div>
				</div>
				<div class="form-actions">
					<input type="button" class="btn btn-primary" value="<?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_GET_BOTTON'); ?>" onclick="Joomla.submitbutton4()" />&nbsp;&nbsp;&nbsp;<small><?php echo JText::_('COM_COSTBENEFITPROJECTION_IMPORT_FORMATS_ACCEPTED'); ?> (.csv .xls .ods)</small>
				</div>
			</fieldset>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		<?php echo JHtml::_('bootstrap.endTabSet'); ?>
	...
	<?php endif; ?>
	<input type="hidden" name="task" value="import_health_data_sets.import" />
