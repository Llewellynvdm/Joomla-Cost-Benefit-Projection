...
class CostbenefitprojectionViewCompanyresults extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		// [3136] We don't need toolbar in the modal window.
		if ($this->getLayout() !== 'modal')
		{
			// [3139] add the tool bar
			$this->addToolBar();
		}

		// [3142] set the document
		$this->setDocument();
	...
	{
		// [3392] load the meta description
		...
		// [3401] load the key words if set
