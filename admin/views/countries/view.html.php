...
/**
 * Costbenefitprojection Html View class for the Countries
 */
class CostbenefitprojectionViewCountries extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = CostbenefitprojectionHelper::getHelpUrl('countries');
