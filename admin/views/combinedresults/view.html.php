...
class CostbenefitprojectionViewCombinedresults extends HtmlView
{
	...
	protected function setDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/administrator/components/com_costbenefitprojection/assets/css/combinedresults.css', (CostbenefitprojectionHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function addToolBar()
	{
		...
		if ($this->canDo->get('combinedresults.companies'))
		{
			...
			JToolBarHelper::custom('combinedresults.gotoCompanies', 'vcard custom-button-gotocompanies', '', 'COM_COSTBENEFITPROJECTION_COMPANIES', false);
		}
