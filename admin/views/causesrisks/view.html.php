...
/**
 * Costbenefitprojection View class for the Causesrisks
 */
class CostbenefitprojectionViewCausesrisks extends JViewLegacy
{
	/**
	...
	protected function addToolBar()
	{
		...
		if ($this->canDo->get('core.import') && $this->canDo->get('causerisk.import'))
		{
			JToolBarHelper::custom('causesrisks.importData', 'upload', '', 'COM_COSTBENEFITPROJECTION_IMPORT_DATA', false);
                ...
                $help_url = CostbenefitprojectionHelper::getHelpUrl('causesrisks');
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_COSTBENEFITPROJECTION_CAUSESRISKS'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_costbenefitprojection/assets/css/causesrisks.css");
	}
