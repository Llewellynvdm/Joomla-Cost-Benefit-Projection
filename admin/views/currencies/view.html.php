...
/**
 * Costbenefitprojection Html View class for the Currencies
 */
class CostbenefitprojectionViewCurrencies extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = CostbenefitprojectionHelper::getHelpUrl('currencies');
