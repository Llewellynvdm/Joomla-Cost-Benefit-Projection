...
class CostbenefitprojectionViewCurrencies extends JViewLegacy
{
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('COM_COSTBENEFITPROJECTION_CURRENCIES'));
		$document->addStyleSheet(JURI::root() . "administrator/components/com_costbenefitprojection/assets/css/currencies.css");
	}
