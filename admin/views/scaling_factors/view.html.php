...
/**
 * Costbenefitprojection Html View class for the Scaling_factors
 */
class CostbenefitprojectionViewScaling_factors extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = CostbenefitprojectionHelper::getHelpUrl('scaling_factors');
