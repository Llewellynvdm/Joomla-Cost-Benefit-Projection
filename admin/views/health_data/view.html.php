...
/**
 * Health_data Html View class
 */
class CostbenefitprojectionViewHealth_data extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = CostbenefitprojectionHelper::getHelpUrl('health_data');
