...
/**
 * Costbenefitprojection Html View class for the Companies
 */
class CostbenefitprojectionViewCompanies extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = CostbenefitprojectionHelper::getHelpUrl('companies');
