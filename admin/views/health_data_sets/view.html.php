...
/**
 * Costbenefitprojection Html View class for the Health_data_sets
 */
class CostbenefitprojectionViewHealth_data_sets extends HtmlView
{
	/**
	...
	protected function addToolBar()
	{
		...
		$this->help_url = CostbenefitprojectionHelper::getHelpUrl('health_data_sets');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_COSTBENEFITPROJECTION_HEALTH_DATA_SETS'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_costbenefitprojection/assets/css/health_data_sets.css", (CostbenefitprojectionHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
