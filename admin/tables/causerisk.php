...
/**
 * Causesrisks Table class
 */
class CostbenefitprojectionTableCauserisk extends JTable
{
	/**
	...
	/**
	 * Overload the store method for the Causerisk table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New causerisk. A causerisk created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_COSTBENEFITPROJECTION_CAUSERISK_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_costbenefitprojection.causerisk.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_costbenefitprojection.causerisk.'.(int) $this->$k;
	}
