 ...
 */
class CostbenefitprojectionTableCountry extends Table
{
	/**
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_COSTBENEFITPROJECTION_COUNTRY_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_costbenefitprojection.country.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_costbenefitprojection.country.'.(int) $this->$k;
	}
